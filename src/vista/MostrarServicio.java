 ...
 * @author Usuario
 */
public class MostrarServicio extends javax.swing.JFrame {

    /**
     * Creates new form MostrarServicio
     */
    ...
    public void llenarTablaServicio(){
        try {
            Conexion3 optica = new Conexion3();
            ResultSet resultado = optica.obtenerTodoServicio();
            
            String columnas[] = {"idservicio","nombreServicio","precio"};
            DefaultTableModel tablaServicio = new DefaultTableModel(columnas, 0);
            
            while(resultado.next()){
                String fila[] = {resultado.getString("idservicio"),
                resultado.getString("nombreServicio"),
                resultado.getString("precio")};
                tablaServicio.addRow(fila);
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(678, 380));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 470, 120));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, 140, -1));

        jTextField2.setEditable(false);
        jTextField2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, 290, -1));

        jTextField3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 260, -1));

        jTextField4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 270, 350, -1));
        ...
        jLabel2.setText("Eliminar Servicio");
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 20, 20));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 330, 90, 30));
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 330, 90, -1));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        x.nombreServicio = jTextField3.getText();
        x.precio = Integer.parseInt(jTextField4.getText());

        Conexion3 optica = new Conexion3();
        optica.agregarServicio(x);
        llenarTablaServicio();
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        if (jTextField3.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"Seleccione un servicio a eliminar");
        }
        try {
        Conexion3 optica = new Conexion3();
        int idservicio = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
        optica.eliminarServicio(idservicio);
        llenarTablaServicio();
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        if (jTextField2.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"Seleccione un servicio a modificar");
        }
        else {
        Servicio x = new Servicio();
        x.idservicio = Integer.parseInt(jTextField2.getText());
        x.nombreServicio = jTextField3.getText();
        x.precio = Integer.parseInt(jTextField4.getText());
        
        Conexion3 optica = new Conexion3();
        optica.modificarServicio(x);
        llenarTablaServicio();
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        // TODO add your handling code here:
        try {
            String nombreServicio = jTextField1.getText();
            Conexion3 optica = new Conexion3();
            ResultSet resultado = optica.buscarServicioNombre(nombreServicio);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarServicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarServicio().setVisible(true);
            }
        });
    }
